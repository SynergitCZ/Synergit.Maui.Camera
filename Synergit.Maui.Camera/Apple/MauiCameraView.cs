...
internal class MauiCameraView : UIView, IAVCaptureVideoDataOutputSampleBufferDelegate, IAVCaptureFileOutputRecordingDelegate, IAVCapturePhotoCaptureDelegate
{
    ...
    private void InitDevices()
    {
        if (!initiated)
        {
            try
            {
                var deviceDescoverySession = AVCaptureDeviceDiscoverySession.Create([AVCaptureDeviceType.BuiltInWideAngleCamera], AVMediaTypes.Video, AVCaptureDevicePosition.Unspecified);
