...
#if IOS || MACCATALYST
using PlatformView = Synergit.Maui.Camera.Platforms.Apple.MauiCameraView;
#elif ANDROID
using PlatformView = Synergit.Maui.Camera.Platforms.Android.MauiCameraView;
#elif WINDOWS
using PlatformView = Synergit.Maui.Camera.Platforms.Windows.MauiCameraView;
