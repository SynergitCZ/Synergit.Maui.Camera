...
1. Download and Install [Synergit.Maui.Camera](https://www.nuget.org/packages/Synergit.Maui.Camera) NuGet package on your application.
...
1. Initialize the plugin in your `MauiProgram.cs`:
    ...
    public static MauiApp CreateMauiApp()
    {
     ...
     builder
      .UseMauiApp<App>()
      .UseSynergitCamera(); // Add the use of the plugging
