...
using CustomRenderer = Synergit.Maui.Camera.Platforms.Windows.SoftwareBitmapRenderer;
#elif IOS || MACCATALYST
using CustomRenderer = Synergit.Maui.Camera.Platforms.Apple.BitmapRenderer;
#elif ANDROID
using CustomRenderer = Synergit.Maui.Camera.Platforms.Android.BitmapRenderer;
#else
